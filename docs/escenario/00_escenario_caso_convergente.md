...
```mermaid
graph TD
    SG[Sean Gallagher<br/>persona física IE / residente ES] --> GH[Gallagher Holdings Ltd<br/>Dublín, Irlanda]
    GH --> IERE[Inmuebles Irlanda<br/>Dublín]
    GH --> PROM[18% promotora de boxeo UK]
    GH --> IW[IronWork Athletics Ltd<br/>marca + e-commerce]
    SG --> AGP[Atalaya Gestión Patrimonial SL<br/>España — family office]
    AGP --> ESRE[Inmuebles España<br/>Costa del Sol]
    SG --> BP[Carteras en banca privada<br/>ES / CH / IE]
```
